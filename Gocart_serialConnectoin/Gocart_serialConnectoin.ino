...
int rotatePos = 10;
int rotateMid = 10;
const int rotateLeftLimit = 6;       
const int rotateRightLimit = 14;      //right가 left보다 더 많이 돎
const int rotate_s_LeftLimit = 9;     //기존 7;
const int rotate_s_RightLimit = 11;   //기존 13;
